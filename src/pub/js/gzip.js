         ...
         */
         zip(str){
            ...
            try{
                ...
                window.console.log(langCheck("0000PUB-000081")+str);/* 国际化处理： 压缩报错：前台原始json*/
            }
         ...
         */
         unzip(str){
            ...
            try{
                ...
                window.console.log(e);
                window.console.log(langCheck("0000PUB-000082")+str);/* 国际化处理： 解压报错--后台原始json:*/
                window.console.log(langCheck("0000PUB-000083")+gstr);/* 国际化处理： 解压报错--前台解码后:*/
            }
